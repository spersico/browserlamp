...
async function openEyeDropper(callback) {
  const eyeDropper = new EyeDropper();
  const result = await eyeDropper.open();
  callback(pickerHexToRgb(result.sRGBHex));
...
export default function RandomColor({ onChangeColor }) {
  return (
    'EyeDropper' in window && (
      <button class='randomColor' onClick={() => openEyeDropper(onChangeColor)} alt="Experimental Eye Dropper API - Limited Browser Support">
        <span>
          <svg
